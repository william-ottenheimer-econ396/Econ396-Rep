...
```{r}
agreaterthanb <- grades[1] > grades[2]
agreaterthanb
agreaterthanb <- grades_fact[1] > grades_fact[2]
agreaterthanb
agreaterthanb <- grades_ord[1] < grades_ord[2]
agreaterthanb
```
...
students$height <- students$height + 1
head(students)
...
#students$President <-  if_else(students$age > 35, TRUE,FALSE)
...
colnames(students) <- c("First.name", "Gender", "Age", "Height", "Grade", "President Eligible")
students
```
